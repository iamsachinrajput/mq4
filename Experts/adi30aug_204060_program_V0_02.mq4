...
extern int lot_multiplier=-2;            // 
extern bool   ConsiderSpread = false;
extern double GridSize = 10;            // pips between orders - grid or mesh size
extern double BaseTakeProfit = 10;        // number of ticks to take profit. normally is = grid size but u can override
...
double    LongLots_quantity=0;
double   ShortLots_quantity=0;
...
//Equity Control Lots
   ...
   if(EquityControlLots)
   {
     ...
     if( lot_multiplier==-1 )
   {
         Lots = Lots + BaseLots  ;                 // total new open Lots
         LongLots = Lots;
         ShortLots = Lots;
   }
     ...
     if( lot_multiplier==-2 )
   {
         Lots = MathAbs(LongLots_quantity-ShortLots_quantity)+ BaseLots ;                 // total new open Lots
         LongLots = Lots;
         ShortLots = Lots;
   }
