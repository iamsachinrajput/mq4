...
extern double StopLoss = 23;  //this is for our BUY/SELL STOP SL 2.3 pips modify, can not put 200 pips, will lose !!!
extern int target_input_points=0 ; 

extern int Filter = 30000;
...
extern int Filter_UJ = 190;
 ...
 double Distance_input = 30; // not used !!!
 double NoTrade_Profit_Yet_Distance = 20;
 double InTrade_Profit_Distance = 30;
...
extern double FixedLots = 0.01;//0.1;
 ...
 extern double MaxSpreadPlusCommission = 160.3 ;//6.3 ok !
...
extern double MaxSpread = 12.6  ;//6.3 ok !
...
//// Calculations for peaks 
 ...
 //if(profit_total-profit_till_last_peak!=0)
 {
   ...
   */
   ...
   string message_to_send="SK#"+Symbol()+equity_msg
