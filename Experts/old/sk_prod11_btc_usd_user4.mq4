...
extern double MaxSpreadPlusCommission = 3500 ;//6.3 ok !
...
// work with GS_digits 
   ...
   {  // New BUY STOP & SELL STOP Orders placed here..
      ...
      printf("######## CHECK #########---- Traded lots="+ total_traded_lots_tillnow +"Profit = " + (current_equity-equity_at_start ) + " equity from " +equity_at_start +" to "+ current_equity+ " Brokerage="+brokerage_total + "------#####--- "  );
