...
extern double StopLoss = 5000;  //this is for our BUY/SELL STOP SL 2.3 pips modify, can not put 200 pips, will lose !!!
...
extern  double sl_trail_active_orders_input = 1000; // not used !!! 30
extern  double NOPROFIT_sl_trail_active_orders_input = 3000;  // 20 
extern  double WITHPROFIT_sl_trail_active_orders_input = 1000;  // 30
 
extern string info2="----Limits=open price calculation of pending orders";
extern  double Limit = 2000;    // 20 will cause order130 error  //23
extern  double NoTrade_Profit_Yet_Limit = 2000;  // can not play with this , 20 should be ok!!!  //22
extern  double InTrade_Profit_Limit = 2000;  //25
