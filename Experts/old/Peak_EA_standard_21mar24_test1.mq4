...
color clr_pending_order_open_buy=clrNONE;//clrBlue;
color clr_pending_order_open_sell=clrNONE;//clrBrown;
...
//// Calculations for peaks 
 ...
 //if(profit_total-profit_till_last_peak!=0)
 {
   ...
   + "\n Current Spread: " + ((Ask-Bid)/usd_points  ) +"/"+int(maxspread*usd_points)
