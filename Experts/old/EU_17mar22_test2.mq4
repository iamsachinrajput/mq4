...
extern int Filter_EU = 1; //org 140
...
extern int Filter_UJ = 190;
 ...
 input string info1="----Distance=modifying SL of Active orders to trail profits . ";
 extern double sl_trail_active_orders_input = 1; // not used !!! 30
...
extern bool Use_TrailingStep = TRUE;
 double Start_Trailing_At = 2.9;  // org 2.9 meaning keep bid/ask sl_trail_active_orders_input by x PIPS
