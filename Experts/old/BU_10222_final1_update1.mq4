...
extern int Minutes_limit_for_order=999999;
...
// work with GS_digits 
   ...
   if (total_orders_open_live <= MaxTrades -1 && buyorsell != 0 ) 
   {  // New BUY STOP & SELL STOP Orders placed here..
      ...
      */
      ...
      printf("########CHECK== Traded lots="+ total_traded_lots_tillnow+"/"+lots_in_this_session+ " Brokerage="+brokerage_total +"/"+brokerage_current
      +" Profit = " + (current_equity-equity_at_start )+"/"+(current_equity-equity_at_start -brokerage_total) + " equity from " +equity_at_start+"/"+total_invested_money+"/"+ equity_allocated_touse
      +" to "+ current_equity+"/"+(current_equity-brokerage_total) +"/"+ usable_equity +"- brokerage("+brokerage_current+ "------#####--- "  );
...
2022.02.10 17:59:00.253	2022.01.30 23:59:55  BU_10222 BTCUSD,M1: ##Account level Equity from 1000 to 484481/235135 Profit=234135 min=917 max_equity=487416
2022.02.10 17:59:00.253	2022.01.30 23:59:55  BU_10222 BTCUSD,M1: ##SL_points_touse=5000 allowed_SL_size=960 StopLoss=3522 Real avg.spread:17.610 maxlotsize=20 Next Lot=20.00
2022.02.10 17:59:00.253	2022.01.30 23:59:55  BU_10222 BTCUSD,M1: ##Params :Filter=35100 SL=5000 TP=0 MaxTrades=10 Risk=0.1
2022.02.10 17:59:00.253	2022.01.30 23:59:55  BU_10222 BTCUSD,M1: ##total_lots_traded=24934.68 Orders=0/2934 Brokerage = 249346
2022.02.10 17:59:00.253	2022.01.30 23:59:55  BU_10222 BTCUSD,M1: ##Profit = 483481 after brokerage = 234135
2022.02.10 17:59:00.253	2022.01.30 23:59:55  BU_10222 BTCUSD,M1: ##Equity from 100*3=300 to 483781 - brokerage=234435 min=11/62 max_equity=237770/486716
